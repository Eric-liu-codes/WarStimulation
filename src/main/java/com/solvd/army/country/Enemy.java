...
public class Enemy extends CountryInfo {
    public Enemy(String countryName, String mainReligion, String government, int population, int yearsOfEstablishment, int numOfSoldiers, CountryTerritory territory) {
